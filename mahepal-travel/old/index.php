...
<html lang="en">
    <head>
        <title>Mahepal Travels new </title>
        <meta charset="utf-8">
		...
		<style>
			.main-navbar.navbar-custom .navbar-brand{ padding-top:10px;}
       ...
       <!-- <div class="loader"></div> !-->
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <div id="info">
                            <ul class="list-unstyled list-inline">                                
                                <li><span><i class="fa fa-phone"></i></span>+91: 9479473941,  8004220777</li>
                                <li><span><i class="fa fa-envelope"></i></span>support@ahoaa.com</li>
                            </ul>
                        </div><!-- end info -->
                    </div><!-- end columns -->
        ...
        <nav class="navbar navbar-default main-navbar navbar-custom navbar-colored" id="mynavbar">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="#" class="navbar-brand"><img src="images/mahepal-logo.png" alt="Logo"></a>
                ...
                <div class="collapse navbar-collapse" id="myNavbar1">
                    <ul class="nav navbar-nav navbar-right ">
                        ...
                        <li class="dropdown"><a href="#">Tours</a></li>
                        <li class="dropdown"><a href="#">Car Rentals</a></li>
                        <li class="dropdown"><a href="#">Gallery</a></li>
                        <li class="dropdown"><a href="#">Get Best Quote</a></li>
		...
		<div class="sidenav-content">
            <div id="mySidenav" class="sidenav" >
                <h2 id="web-name"><span><i class="fa fa-plane"></i></span>Mahepal Travels</h2>
		...
		<!--========================= FLEX SLIDER =====================-->
        <section class="flexslider-container" id="flexslider-container-4" style="margin: 0">            
            <div class="flexslider slider tour-slider" id="slider-4">
                <ul class="slides">                    
                    <li class="item-1 back-size" style="background:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url(images/slider-01.jpg) 50% 15%;
	background-size:cover;	height:100%;">
                    	<div class="meta">         
                            <div class="container">
                            	<span class="highlight-price highlight-2">STARTING FROM 1200$ ONLY</span>
                                <h2>Mahepal Travels</h2>
                                <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
                            </div><!-- end container -->  
                        </div><!-- end meta -->
                    </li><!-- end item-1 -->
                    
                    <li class="item-2 back-size" style="background:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url(images/slider-02.jpg) 50% 15%;
	background-size:cover;	height:100%;">
                        <div class=" meta">         
                            <div class="container">
                            	<span class="highlight-price highlight-2">STARTING FROM 1200$ ONLY</span>
                         ...
                         <div class="owl-carousel owl-theme owl-custom-arrow" id="owl-tour-offers">                            
                            <div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                    	<a href="#">
                                        	<img src="images/ser-03.png" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div>
							...
							<div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                    	<a href="#">
                                        	<img src="images/ser-01.png" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div>
							...
							<div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                    	<a href="#">
                                        	<img src="images/ser-02.png" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div>
							...
							<div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                    	<a href="#">
                                        	<img src="images/ser-04.png" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div>
							...
							<div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                    	<a href="#">
                                        	<img src="images/ser-05.png" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div>
                                        
                                    <div class="main-info tour-info">
                                    	<div class="main-title tour-title">
                                            <a href="#"> Holliday Packages</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- ==================== tour package ================!-->
        	<section id="gridGallery">
                <div class="container">
                     <div class="page-heading">
            <h2>Recommended Tours Packages</h2>
            <hr class="heading-line">
                      </div>
                     <div class="row">
      ...
      <div class="col-sm-3 col-xs-6 box" id="boxSix">
        ...
        <section id="footer" class="ftr-heading-w ftr-heading-mgn-2">
            ...
            <div id="footer-top" class="banner-padding ftr-top-grey ftr-text-grey">
                    <div class="container clear-padding sm-footer">
                <div class="col-md-3 col-sm-6 footer-about-box">
                    <h4>Mahepal Travels</h4>
                ...
                <div class="col-md-3 col-sm-6 contact-box">
                    <h4>CONTACT US</h4>
                    <p><i class="fa fa-home"></i> B- 55, 2<sup>nd</sup>&nbsp; floor, Lowther Road George town Prayagraj (Allahabad),<br> 211002</p>
                    <p><i class="fa fa-envelope-o"></i> support@ahoaa.com </p>
                    <p><i class="fa fa-phone"></i> +91 8004220777 / 9479473941 </p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="copyright">
                            <p>&copy; 2019 <a href="#"> Mahepal Travels </a> || All rights reserved.</p>
                        </div><!-- end columns -->
                        
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="terms">
                            <ul class="list-unstyled list-inline">
                            	<li> <a href="#">Web Curved Technology</a></li>
